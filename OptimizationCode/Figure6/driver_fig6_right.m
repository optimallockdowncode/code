...
for count = 1:length(vals)
    clearvars -except vals INDEP_VARIABLE count Y De totalQ N T eps vslVal
    ...
    T = 364;
    dt = 7; % this is the finest resolution
    ...
    Constants = ...
        ...
        'theta',vals(count); %; %0.25     %mixing rate for quarantined population
