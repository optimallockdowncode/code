...
for count1 = 1:length(vals1)
   ...
   Constants = ...
        ...
        'kappa',vals1(count1)*gamma; %excess deaths  was at 0.034
        'c1',1e-4;      
        'c2',1e-4;
...
save fig7A.mat vals1 vals2 Y De totalQ N T eps INDEP_VARIABLE1 INDEP_VARIABLE2
plotFig7A;