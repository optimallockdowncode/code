...
for count1 = 1:length(vals1)
   ...
   Constants = ...
        ...
        'theta', vals1(count1); %0.25     %mixing rate for quarantined population
...
save fig7B.mat vals1 vals2 Y De totalQ N T eps INDEP_VARIABLE1 INDEP_VARIABLE2
plotFig7B;