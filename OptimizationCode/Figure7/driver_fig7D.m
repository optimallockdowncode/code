...
for count1 = 1:length(vals1)
   ...
   Constants = ...
        ...
        'beta', vals1(count1)*m;   %bench = 0.24*  %transmission/contact rate %%% CORRECTED
...
save fig7D.mat vals1 vals2 Y De totalQ N T eps INDEP_VARIABLE1 INDEP_VARIABLE2
plotFig7D;