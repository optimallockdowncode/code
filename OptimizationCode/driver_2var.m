...
% The script will run simulations for each pair of values you specify
% and plot results like those seen in figure 7
%
% NOTE: also edit lines 43-59 below so that 
%           the variables you want receives these values
INDEP_VARIABLE1 = "b1";
INDEP_VARIABLE2 = "VSL";
vals1 = 0.01:0.01:0.05;
vals2 = 20:20:80;
...
for count1 = 1:length(vals1)
    ...
    T = 364;
    dt = 7; %%% NOTE: THIS IS SET TO LOW RESOLUTION SO IT RUNS FASTER
            %%%       THE SIMULATIONS IN THE MANUSCRIPT HAVE dt = 1
            %%%       AND T = 365
    t = 0:dt:T;
   ...
   Constants = ...
        ...
        'b1', vals1(count1); %0.008; % bench = 0.01 
        'b2',13.5; %bench = 13.5
        'b3', 0.016; 
        'vsl',vals2(count2); %bench = 40
        };
