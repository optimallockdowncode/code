...
%
% NOTE: also edit lines 41-57 below so that 
...
for count = 1:length(vals)
    ...
    Constants = ...
        ...
        'kappa',0.05*gamma; %excess deaths
        'c1',1e-4;      
        'c2',1e-4;
        'a',0.5; %weight on economic vs healthcare objective
        'vsl', 40; %bench = 40 
        'b1', 0.008; % bench = 0.008 
        'b2',13.5; %bench = 13.5
        'b3',vals(count) % bench = 0.016
        };
    ...
    save('current_indiv_run.mat','vals','N','T','eps','z','INDEP_VARIABLE');
    
end

%% save full results for Acemoglu type plots in a data file called 'current.mat'
save current.mat vals Y De totalQ N T eps INDEP_VARIABLE